        ...
        <div className="grid gap-3 xl:grid-cols-[0.92fr_1.28fr]">
          {primary ? (
            <button
              ...
              className="group min-h-[260px] rounded-[var(--radius-xl)] border border-[var(--hairline)] bg-[var(--material-inset)] p-4 text-left transition hover:border-[var(--hairline-strong)] hover:bg-[var(--material-muted)] sm:p-5 xl:min-h-full"
            >
              ...
              <h3 className="mt-4 text-xl font-semibold leading-snug text-[var(--text-primary)] group-hover:text-[var(--primary)]">
                {primary.title}
              </h3>
            ...
            {secondary.map((item) => {
              ...
              return (
                <button
                  ...
                  className="group rounded-[var(--radius-lg)] border border-[var(--hairline)] bg-[var(--material-inset)] px-3.5 py-3 text-left transition hover:border-[var(--hairline-strong)] hover:bg-[var(--material-muted)]"
                >
