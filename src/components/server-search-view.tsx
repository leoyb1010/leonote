...
export function ServerSearchView() {
  ...
  return (
    <div className="space-y-4">
      <PageHeader title="搜索" description={items.length > 0 ? `${items.length} 条结果` : undefined} />

      <div className="rounded-[var(--radius-lg)] bg-[var(--surface-1)] p-3 ring-1 ring-[var(--border-default)] space-y-3">
      ...
      {message && <p className="rounded-[var(--radius-lg)] bg-[var(--surface-1)] p-4 text-sm text-[var(--text-muted)]">{message}</p>}
