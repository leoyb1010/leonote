...
export function BottomNav({ currentPath }: BottomNavProps) {
  ...
  return (
    <nav className="lg:hidden fixed bottom-0 left-0 right-0 z-50 bg-[var(--surface-overlay)] border-t border-[var(--border-default)] backdrop-blur-xl safe-area-bottom">
