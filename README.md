...
- AI 思考信号加强：新增“特朗普访华与 AI 芯片”“中美议程里的科技变量”“AI 芯片出口许可”等战略信号识别；“中美议程”必须同时命中高层/外交语境、双边语境和政策议题，避免普通 AI、手机、汽车、家电资讯被误贴成地缘线索
...
| 版本 | 日期 | 更新内容 |
|---|---|---|
| **v1.6.7** | 2026-05-11 | 修复浮层定位根因：普通 `card-premium` 全局样式会把 `fixed` 定位覆盖成 `relative`，导致全局 AI 助手从左侧错位呼出、AI 协助思考气泡不按点击位置弹出；新增专用 `floating-card-premium`，全局 AI 助手、AI 思考详情、资讯详情弹窗统一使用真实固定定位。AI 助手桌面端保持右侧内容伴随面板，移动端使用完整安全面板；AI 思考详情改为按鼠标点击坐标居中锚定，空间不足时自动上翻/边界夹紧。收窄“中美议程里的科技变量”战略信号触发条件，必须同时满足高层/外交语境、双边语境和政策议题，避免普通 AI、手机、汽车、家电资讯被误判成中美议程；新增回归测试覆盖普通资讯不误贴“中美议程”和特朗普访华/黄仁勋/AI 芯片案例仍能命中战略信号 |
