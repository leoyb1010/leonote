...
- AI 思考区版面优化：保留 6 条思考信息，但从“六张等权卡片”调整为“1 条主思考 + 5 条紧凑入口”，降低首屏空白和卡片重复感，让 Hero 更像今日判断入口而不是信息堆叠
...
- 今日星座运势：天气信息后展示袁博=我/天秤座、张云=老婆/双鱼座、袁晨希=女儿/双子座；实时源优先使用 FreeHoroscopeAPI 今日 JSON，其次 Horoscope.com / Astrology.com 今日页，AstroSage RSS 仅在新鲜度校验通过时作为备选；过期 RSS 会被拒绝，不再使用本地运势兜底文案；英文源会优先用已配置 AI 翻译为简体中文，无 AI Key 时使用源文本驱动的中文摘要
